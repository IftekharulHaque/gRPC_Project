...
public final class studentGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Student.LoginRequest,
      Student.Response> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Login",
      requestType = Student.LoginRequest.class,
      responseType = Student.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Student.LoginRequest,
      Student.Response> getLoginMethod() {
    io.grpc.MethodDescriptor<Student.LoginRequest, Student.Response> getLoginMethod;
    if ((getLoginMethod = studentGrpc.getLoginMethod) == null) {
      synchronized (studentGrpc.class) {
        if ((getLoginMethod = studentGrpc.getLoginMethod) == null) {
          studentGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<Student.LoginRequest, Student.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "student", "Login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Student.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Student.Response.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Student.RegisterRequest,
      Student.RegResponse> getRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Register",
      requestType = Student.RegisterRequest.class,
      responseType = Student.RegResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Student.RegisterRequest,
      Student.RegResponse> getRegisterMethod() {
    io.grpc.MethodDescriptor<Student.RegisterRequest, Student.RegResponse> getRegisterMethod;
    if ((getRegisterMethod = studentGrpc.getRegisterMethod) == null) {
      synchronized (studentGrpc.class) {
        if ((getRegisterMethod = studentGrpc.getRegisterMethod) == null) {
          studentGrpc.getRegisterMethod = getRegisterMethod = 
              io.grpc.MethodDescriptor.<Student.RegisterRequest, Student.RegResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "student", "Register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Student.RegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Student.RegResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Student.LogoutRequest,
      Student.Response> getLogoutMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Logout",
      requestType = Student.LogoutRequest.class,
      responseType = Student.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Student.LogoutRequest,
      Student.Response> getLogoutMethod() {
    io.grpc.MethodDescriptor<Student.LogoutRequest, Student.Response> getLogoutMethod;
    if ((getLogoutMethod = studentGrpc.getLogoutMethod) == null) {
      synchronized (studentGrpc.class) {
        if ((getLogoutMethod = studentGrpc.getLogoutMethod) == null) {
          studentGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<Student.LogoutRequest, Student.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "student", "Logout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Student.LogoutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Student.Response.getDefaultInstance()))
  ...
  public static abstract class studentImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(Student.LoginRequest request,
                      io.grpc.stub.StreamObserver<Student.Response> responseObserver) throws SQLException, ClassNotFoundException {
      asyncUnimplementedUnaryCall(getLoginMethod(), responseObserver);
    }

    /**
     */
    public void register(Student.RegisterRequest request,
                         io.grpc.stub.StreamObserver<Student.RegResponse> responseObserver) throws SQLException {
      asyncUnimplementedUnaryCall(getRegisterMethod(), responseObserver);
    }

    /**
     */
    public void logout(Student.LogoutRequest request,
  ...
  public static final class studentBlockingStub extends io.grpc.stub.AbstractStub<studentBlockingStub> {
    ...
    /**
     */
    public Student.Response login(Student.LoginRequest request) {
    ...
    /**
     */
    public Student.RegResponse register(Student.RegisterRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public Student.Response logout(Student.LogoutRequest request) {
      return blockingUnaryCall(
  ...
  public static final class studentFutureStub extends io.grpc.stub.AbstractStub<studentFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Student.Response> login(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Student.RegResponse> register(
        Student.RegisterRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Student.Response> logout(
        Student.LogoutRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_LOGOUT:
          serviceImpl.logout((Student.LogoutRequest) request,
              (io.grpc.stub.StreamObserver<Student.Response>) responseObserver);
          break;
        default:
